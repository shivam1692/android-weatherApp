...
class CurrentCityTempViewModelTest {
    ...
    fun getWeatherForecast_testErrorHandlingForEmpyResponse(){
        MediatorLiveData<Int>().apply {
            addSource(viewModel.getWeatherForecast("10.23456","10.9346")){
               Assert.assertEquals(application.getString(R.string.no_data_found),viewModel.errorMessage.value)
            }
        }
    }
    ...
    fun getWeatherForecast_testErrorHandlingForApiError(){
        MediatorLiveData<Int>().apply {
            addSource(viewModel.getWeatherForecast("10.23457","10.9347")){
    ...
    fun getWeatherForecast_testValidResponseAndParsing(){
        MediatorLiveData<Int>().apply {
            addSource(viewModel.getWeatherForecast("10.234547","10.93474")){
